...
object AnalyticStrings {
  ...
  val analyticsContactsActionScanContact = "Scan Contact"

  val analyticsSponsorsScreen = "Sponsors"

  val analyticsSponsorsActionGoToSponsor = "Go to Sponsor"

  val analyticsPlacesScreen = "Places"

  val analyticsPlacesActionGoToMap = "Go to Map"
